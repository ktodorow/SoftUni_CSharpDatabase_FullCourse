...
(
	...
	BedCount INT NOT NULL --exclusive =X / inclusive ==
...
('Johan Müller', '322-876-9826', 'j.muller@example.com', 4),
...
--05
SELECT 
	   --SUBSTRING(CAST(ArrivalDate AS varchar), 1, 10) AS [ArrivalDate],
...
SELECT * FROM Bookings WHERE RoomId = 2
SELECT * FROM Rooms
